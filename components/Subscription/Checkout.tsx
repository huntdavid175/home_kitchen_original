...
const plan = storedPlan ? JSON.parse(storedPlan) : { name: "Basic", price: 19.99 };
        ...
        <Card className="shadow-xl rounded-2xl py-4 lg:py-6 lg:px-6 bg-white">
          ...
          <CardContent>
            ...
            <form className="space-y-4">
              ...
              <div className="flex gap-4">
              <Button onClick={Goback} className="w-full bg-red-200 text-black hover:bg-red-300" disabled={loading}>
                Go Back
              </Button>
